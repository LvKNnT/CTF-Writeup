...
_sage_const_13390 = Integer(13390); _sage_const_127 = Integer(127); _sage_const_300 = Integer(300); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)
from pwn import *
import json
...
def solve():
    ...
    base_a_tuple = a_counts.most_common(_sage_const_1 )[_sage_const_0 ][_sage_const_0 ]
    ...
    for s in samples:
        ...
        try:
            inv_a = pow(delta_a, -_sage_const_1 , q)
