...
_sage_const_419 = Integer(419); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3)# CryptoHack - Road to CSIDH - Twisted CSIDH Isogenies
...
for _ in range(k - _sage_const_1 ):
    E_forward = ell_isogeny_step(E_forward, _sage_const_7 )

E_backward = ell_isogeny_step_backwards(E0, _sage_const_7 )
...
E_back3 = ell_isogeny_step_backwards(E0, _sage_const_3 )
