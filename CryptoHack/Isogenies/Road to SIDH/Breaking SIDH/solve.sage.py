...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_128 = Integer(128); _sage_const_16 = Integer(16)# CryptoHack - Road to SIDH - Breaking SIDH
#
...
assert p == f * _sage_const_2 **a * _sage_const_3 **b - _sage_const_1 

E_start = E0
E_start.set_order((p + _sage_const_1 )**_sage_const_2 )
EA.set_order((p + _sage_const_1 )**_sage_const_2 )
EB.set_order((p + _sage_const_1 )**_sage_const_2 )
...
assert _sage_const_2 **a * P2 == E_start(_sage_const_0 ) and _sage_const_2 **(a - _sage_const_1 ) * P2 != E_start(_sage_const_0 )
assert _sage_const_3 **b * P3 == E_start(_sage_const_0 ) and _sage_const_3 **(b - _sage_const_1 ) * P3 != E_start(_sage_const_0 )
assert _sage_const_2 **a * PB == EB(_sage_const_0 ) and _sage_const_2 **(a - _sage_const_1 ) * PB != EB(_sage_const_0 )
...
def two_i(P):
    if P.is_zero():
        return P
    x, y = P.xy()
    return _sage_const_2  * P.curve()(-x, i * y)


# quick self-check that two_i really is a degree-4, trace-0 endomorphism
_T = _sage_const_3 **(b - _sage_const_1 ) * P3
assert two_i(two_i(_T)) == -_sage_const_4  * _T, "two_i^2 must equal [-4]"
...
if __name__ == '__main__' and '__file__' in globals():
    ...
    assert _sage_const_3 **b * K_shared == EA(_sage_const_0 )
    ...
    flag = unpad(cipher.decrypt(bytes.fromhex(ct)), _sage_const_16 )
    print(flag.decode())
